...
class CleaningDispatcher:
    ...
    def dispatch(cls, data_model: NoSQLBaseDocument) -> VectorBaseDocument:
        ...
        logger.info(
            "Document cleaned successfully.", data_category=data_category, cleaned_content_len=len(clean_model.content)
        )
...
class ChunkingDispatcher:
    ...
    def dispatch(cls, data_model: VectorBaseDocument) -> list[VectorBaseDocument]:
        ...
        logger.info("Document chunked successfully.", num=len(chunk_models), data_category=data_category)
